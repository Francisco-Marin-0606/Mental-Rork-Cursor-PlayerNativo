...
export default function DeleteTrackModal({ visible, onClose, onConfirm, trackTitle }: DeleteTrackModalProps) {
        ...
        >
          <View style={styles.content}>
            ...
            <Text style={styles.message}>
              ¿Estás seguro que deseas eliminar &ldquo;{trackTitle}&rdquo; de tus descargas?
            </Text>
